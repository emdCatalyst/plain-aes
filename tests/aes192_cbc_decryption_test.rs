use plain_aes::{decrypt, CipherVersion, ModeOfOperation};

#[test]
fn decrypt_aes192_cbc_u8_block_1() {
    let key: &[u8] = &[
    ...
    let result = decrypt(cipher, CipherVersion::Aes192(key, ModeOfOperation::CBC(iv)));
    assert!(plain.iter().eq(result.unwrap().iter()))
}
#[test]
fn decrypt_aes192_cbc_u8_block_2() {
    let key: &[u8] = &[
        0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79,
        0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b,
    ];
...
#[test]
fn decrypt_aes192_cbc_u8_block_3() {
    let key: &[u8] = &[
        0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79,
        0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b,
    ];
...
#[test]
fn decrypt_aes192_cbc_u8_block_4() {
    let key: &[u8] = &[
        0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79,
        0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b,
    ];
...
fn decrypt_aes192_cbc_str() {
    ...
    let result = decrypt(
        &cipher[..],
        CipherVersion::Aes192(key, ModeOfOperation::CBC(iv)),
    );
