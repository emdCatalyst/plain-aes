...
#[test]
fn decrypt_aes128_cbc_u8_block_1() {
    let key: &[u8] = &[
    ...
    let result = decrypt(cipher, CipherVersion::Aes128(key, ModeOfOperation::CBC(iv)));
    assert!(plain.iter().eq(result.unwrap().iter()))
}
#[test]
fn decrypt_aes128_cbc_u8_block_2() {
    let key: &[u8] = &[
        0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f,
        0x3c,
    ];
...
#[test]
fn decrypt_aes128_cbc_u8_block_3() {
    let key: &[u8] = &[
        0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f,
        0x3c,
    ];
...
#[test]
fn decrypt_aes128_cbc_u8_block_4() {
    let key: &[u8] = &[
        0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f,
        0x3c,
    ];
...
#[test]
fn decrypt_aes128_cbc_empty_string_empty_u8() {
    let cipher = "".as_bytes(); // Empty slice.
    let cipher2 = ""; // Empty string
    let key: &[u8] = &[
        0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f,
        0x3c,
    ];
...
fn decrypt_aes128_cbc_key_expansion_failure() {
    ...
    let result = decrypt(plain, CipherVersion::Aes128(&key, ModeOfOperation::CBC(iv)));
    assert_eq!(
        result.unwrap_err(),
...
#[test]
fn decrypt_aes128_cbc_invalid_target_size() {
    let key: &[u8] = &[
        0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f,
        0x3c,
    ];
